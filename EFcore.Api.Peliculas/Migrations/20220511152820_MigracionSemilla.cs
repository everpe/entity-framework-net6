...
{
    public partial class MigracionSemilla : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, true, new DateTime(2022, 5, 11, 0, 0, 0, 0, DateTimeKind.Local), "https://upload.wikimedia.org/wikipedia/en/5/50/The_Matrix_Resurrections.jpg", "The Matrix Resurrections" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 5, 18, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 5, 11, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 5, 16, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 5, 11, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "PeliculasId", "SalasCineId" },
                values: new object[,]
                {
                    { 5, 1 },
                    { 5, 2 },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "PeliculaSalaCine",
                keyColumns: new[] { "PeliculasId", "SalasCineId" },
