...
namespace EFcore.Api.Peliculas.Entidades.Seeding
{
    public static class SeedingModuloConsulta
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var agoraOfertaCine = new OfertaCine { Id = 1, CineId = agora.Id, FechaInicio = DateTime.Today, FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 10 };
            ...
            var acropolisOfertaCine = new OfertaCine { Id = 2, CineId = acropolis.Id, FechaInicio = DateTime.Today, FechaFin = DateTime.Today.AddDays(5), PorcentajeDescuento = 15 };

            modelBuilder.Entity<Cine>().HasData(acropolis, sambil, megacentro, agora);
            modelBuilder.Entity<OfertaCine>().HasData(acropolisOfertaCine, agoraOfertaCine);
            ...
            var salaDeCineIdPropiedad = "SalasCineId";
